...
SHORT_DESCRIPTION = "Satellite-Based Energy Balance for Mapping Evapotranspiration with Internalized Calibration (METRIC) model to estimate sensible and latent heat flux (evapotranspiration) from radiometric surface temperature data"

REQS = ['numpy>=1.10', 'gdal', 'bokeh', 'pandas', 'netCDF4', 'pyTSEB']

setup(
    name                  = "pyMETRIC",
    packages              = ['pyMETRIC'],
    dependency_links      = ['http://github.com/hectornieto/pyTSEB/tarball/master#egg=pyTSEB-v1.0'],
    ...
    keywords             = ['METRIC','One Source Energy Balance',
        'Resistance Energy Balance','OSEB','Remote Sensing'])
